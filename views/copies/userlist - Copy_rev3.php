...
foreach ($items as $item)
    ...
    echo '<div class="col-12 col-md-1 p-2">
          ...
          <div class="d-flex">
              <input type="hidden" id="updatecheckedonlistulid'.htmlspecialchars($item["userListItemId"]).'" class="updatecheckedonlist" name="updatecheckedonlist" value="false">            
              <input type="hidden" id="checked_on_listulid'.htmlspecialchars($item["userListItemId"]).'" class="gotitfrm" name="checked_on_list" value="'.htmlspecialchars($item["checked_on_list"]).'">
              <input type="hidden" class="useritemid" name="userListItemId" value="'.htmlspecialchars($item["userListItemId"]).'">
              <input type="button" class="mx-md-auto btn btn-default gotit" value="Got It!"> 
              </div>            
        </div>';
    ...
    echo '<div class="col-3 col-md-1 p-2">
        ...
        <div class="d-flex">            
            <input type="text" id="quantityulid'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformquantity" style="text-align: center;" name="quantity" readonly="readonly" value="'.htmlspecialchars($item["quantity"]).'"required maxlength="10">
        </div>            
      </div>';
    /* echo '<div class="col-12 col-md-1 p-2 text-center">                
    ...
    echo '<div class="col-12 col-md-2 p-2">
            ...
            <div class="d-flex">            
                <input type="text" id="categoryulid'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformcategory" style="text-align: center;" name="categoryName" readonly="readonly" value="'.htmlspecialchars($item["categoryName"]).'"required maxlength="10">
            </div>            
          </div>';
    echo '<div class="col-12 col-md-2 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Store: </div>
            <div class="d-flex">            
                <input type="text" id="storeulid'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformstore" style="text-align: center;" name="storeName" readonly="readonly" value="'.htmlspecialchars($item["storeName"]).'"required maxlength="250">
            </div>            
          </div>';
    echo '<div class="col-12 col-md-2 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Frequency: </div>
            <div class="d-flex">            
                <input type="text" id="frequencyulid'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformfrequency" style="text-align: center;" name="frequency" readonly="readonly" value="'.htmlspecialchars($item["frequency"]).'"required maxlength="50">
            </div>           
          </div>';   
    /* echo '<div class="col-12 col-md-1 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Category: </div>
    ...
    echo '<div class="col-12 col-md-1 p-2">          
            ...
            <input type="submit" id="savedeleteulid'.htmlspecialchars($item["userListItemId"]).'" class="savedelete mx-auto deleteitem" value="Delete"> 
            </div>            
          </div>';
