...
foreach ($items as $item)
    ...
    echo '<div class="col-12 col-md-2 p-2">
            ...
            <div class="d-flex categorycontainer categoryulid'.htmlspecialchars($item["userListItemId"]).'" data-ulid="'.htmlspecialchars($item["userListItemId"]).'">            
                <input type="text" id="categoryulid'.htmlspecialchars($item["userListItemId"]).'" data-ulid="'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformcategory" style="text-align: center;" name="categoryName" readonly="readonly" value="'.htmlspecialchars($item["categoryName"]).'">
            </div>            
          </div>';
    echo '<div class="col-12 col-md-2 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Store: </div>
            <div class="d-flex">            
                <input type="text" id="storeulid'.htmlspecialchars($item["userListItemId"]).'" data-ulid="'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformstore" style="text-align: center;" name="storeName" readonly="readonly" value="'.htmlspecialchars($item["storeName"]).'"required maxlength="250">
            </div>            
          </div>';
    echo '<div class="col-12 col-md-2 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Frequency: </div>
            <div class="d-flex">            
                <input type="text" id="frequencyulid'.htmlspecialchars($item["userListItemId"]).'" data-ulid="'.htmlspecialchars($item["userListItemId"]).'" class="form-control editformfrequency" style="text-align: center;" name="frequency" readonly="readonly" value="'.htmlspecialchars($item["frequency"]).'"required maxlength="50">
            </div>           
          </div>';   
    /* echo '<div class="col-12 col-md-1 p-2">
            <div class="d-md-none d-inline-flex font-weight-bold">Category: </div>
