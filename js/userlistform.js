  $(document).ready(function() {
    ...
    {        
        ...
        $('#savedeleteulid'+userlistitemid).toggleClass('delete', false);
        $('#savedeleteulid'+userlistitemid).toggleClass('save', true);
    ...
    $('.editformquantity').focusout(function(event)    
    {
        ...
        $('#savedeleteulid'+userlistitemid).toggleClass('save', false);             
        $('#savedeleteulid'+userlistitemid).toggleClass('delete', true);
    ...
    $('.saveordelete').on('click', '.save', function(event) {
        //alert('at on delegate');        
        var userlistitemid = event.currentTarget.dataset.ulid;
        //alert(userlistitemid);
    //});  
    ...
    $('.saveordelete').on('click', '.delete', function(event) {        
        
        var userlistitemid = event.currentTarget.dataset.ulid;
        var itemwrapper = '.itemwrapper'+userlistitemid;
        var itemborder = '.itemborder'+userlistitemid;
        
        var formData = {
            update_action: 'deletelistitem',                       
            userListItemId: userlistitemid
        };
